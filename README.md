...
It's the [egghead React Fundamentals Course](https://egghead.io/courses/react-fundamentals) but each video's example is displayed using [React Storybook](https://getstorybook.io/)

Quickstart
### `npm start` for just the app
### `npm run storybook` for the app in Storybook
